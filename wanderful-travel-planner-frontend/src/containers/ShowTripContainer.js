...
const ShowTripContainer = ({getTrip, editTrip, deleteTrip}) => {
        ...
        return (
            <Tab.Container defaultActiveKey="first">
                <Row>
                    <Col sm={2} >
                        <Styles>
                            {/* TODO: get each tab to be a link */}
                        <Nav variant="pills" className="justify-content-start sidebar">
                        <Nav.Item>
                            <Nav.Link href={`/trips/${tripId}`} eventKey="first">Trip Info</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link href={`/trips/${tripId}/itinerary`} eventKey="second">Itinerary</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
