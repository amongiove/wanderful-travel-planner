            ...
            <ListGroup.Item> 
                <Row>
                    ...
                    <Col className="checkin" md={3}>
                        Check in: {moment(accomodation.attributes.start_date_time).format("MM-DD-YYYY h:mm A")}  
                    </Col>
                    <Col className="checkout" md={3}>
                        Check out: {moment(accomodation.attributes.end_date_time).format("MM-DD-YYYY h:mm A")}
                    </Col>
                    <Col md={2}>
